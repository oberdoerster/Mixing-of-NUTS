...
figure(1); hold on;
histogram(x2_vec(2:3,:),(n_dim-10*sqrt(n_dim):25:n_dim+10*sqrt(n_dim)),'Normalization','pdf','FaceColor',[0.5,0.5,0.5]);
plot(domain,chi2pdf(domain,n_dim),'k','LineWidth',5);
plot(norm(init)^2,0,'k.','MarkerSize',60);
set(gca,'fontsize', 25);
...
figure(2); hold on;
histogram(x2_vec(26:51,:),(n_dim-10*sqrt(n_dim):25:n_dim+10*sqrt(n_dim)),'Normalization','pdf','FaceColor',[0.5,0.5,0.5]);
plot(domain,chi2pdf(domain,n_dim),'k','LineWidth',5);
plot(norm(init)^2,0,'k.','MarkerSize',60);
set(gca,'fontsize', 25);
xlim([n_dim-6*sqrt(n_dim) n_dim+6*sqrt(n_dim)]);
...
figure(3); hold on;
histogram(x2_vec(636:661,:),(n_dim-10*sqrt(n_dim):25:n_dim+10*sqrt(n_dim)),'Normalization','pdf','FaceColor',[0.5,0.5,0.5]);
plot(domain,chi2pdf(domain,n_dim),'k','LineWidth',5);
plot(norm(init)^2,0,'k.','MarkerSize',60);
set(gca,'fontsize', 25);
xlim([n_dim-6*sqrt(n_dim) n_dim+6*sqrt(n_dim)]);
...
figure(4); hold on;
histogram(x2_vec(1976:2001,:),(n_dim-10*sqrt(n_dim):25:n_dim+10*sqrt(n_dim)),'Normalization','pdf','FaceColor',[0.5,0.5,0.5]);
plot(domain,chi2pdf(domain,n_dim),'k','LineWidth',5);
plot(norm(init)^2,0,'k.','MarkerSize',60);
set(gca,'fontsize', 25);
xlim([n_dim-6*sqrt(n_dim) n_dim+6*sqrt(n_dim)]);
